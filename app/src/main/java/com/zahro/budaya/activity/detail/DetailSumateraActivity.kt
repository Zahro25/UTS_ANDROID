...
import com.zahro.budaya.activity.SumateraActivity
import com.zahro.budaya.model.Image

class DetailSumateraActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_sumatera)
        val image = intent.getParcelableExtra<Image>(SumateraActivity.INTENT_PARCELABLE)
